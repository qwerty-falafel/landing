...
function Header() {
  return (
    <Container className="mt-16">
      <Heading as="h1">A Better Future for Photojournalism</Heading>
      <Lead className="mt-6 max-w-3xl">
        ShutterLedger is dedicated to empowering photojournalists, editors, and production teams alike. By offering a transparent and ethical platform, we aim to provide fair earnings, secure licensing, and efficient workflows for everyone involved in creating and sharing impactful visual stories.
      </Lead>
      <section className="mt-16 grid grid-cols-1 lg:grid-cols-2 lg:gap-12">
        <div className="max-w-lg">
          <h2 className="text-2xl font-medium tracking-tight">Our Mission</h2>
          <p className="mt-6 text-sm/6 text-gray-600">
            We exist to connect talented creators directly with the organizations that value their work. By combining AI-driven metadata tools with flexible licensing options, we ensure photojournalists retain control over their images while editors and buyers access authentic, high-quality content in real time.
          </p>
          <p className="mt-6 text-sm/6 text-gray-600">
            We exist to connect talented creators directly with the organizations that value their work. By combining AI-driven metadata tools with flexible licensing options, we ensure photojournalists retain control over their images while editors and buyers access authentic, high-quality content in real time.
          </p>
          <p className="mt-8 text-sm/6 text-gray-600">
            Our ultimate goal is to reshape the visual storytelling industry by prioritizing fairness, transparency, and innovation. From war-zone photography to local feature stories, we believe in celebrating diverse perspectives while safeguarding the rights and livelihoods of those behind the lens.
          </p>
          <br />
          <h2 className="text-2xl font-medium tracking-tight">Our Mission</h2>
          <p className="mt-6 text-sm/6 text-gray-600">
